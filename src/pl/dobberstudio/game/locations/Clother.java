...
public class Clother extends Location
{
    ...
    public Clother(GameManager gm, String path, Character character)
    {
        ...
        clothes[0] = new ToadProduct(gm, "clother/adidas_hat.png", 250, 2, 5);
        ...
        clothes[1] = new ToadProduct(gm, "clother/kasket.png", 700, 2, 20);
        ...
        clothes[2] = new ToadProduct(gm, "clother/slash.png", 970, 2, 100);
        ...
        clothes[2].setOnClick(() -> {
            if((character.getMoney() >= clothes[2].getPrice()) && (character.getEquipment().getHeadValue() < clothes[2].getValue())) {
                ...
                character.addLook(50);
            }
        });
        clothes[3] = new ToadProduct(gm, "clother/wifepuncher.png", 250, 160, 5);
        ...
        clothes[4] = new ToadProduct(gm, "clother/thrasher.png", 700, 160, 20);
        ...
        clothes[5] = new ToadProduct(gm, "clother/jacket.png", 970, 160, 50);
        ...
        clothes[5].setOnClick(() -> {
            if((character.getMoney() >= clothes[5].getPrice()) && (character.getEquipment().getBodyValue() < clothes[5].getValue())) {
                ...
                character.addLook(25);
            }
        });
        clothes[6] = new ToadProduct(gm, "clother/pants.png", 250, 330, 5);
        ...
        clothes[7] = new ToadProduct(gm, "clother/builder_pants.png", 700, 330, 20);
        ...
        clothes[8] = new ToadProduct(gm, "clother/jeans.png", 970, 330, 50);
        ...
        clothes[9] = new ToadProduct(gm, "clother/kubota.png", 250, 500, 5);
        ...
        clothes[10] = new ToadProduct(gm, "clother/shoes.png", 700, 500, 20);
        ...
        clothes[11] = new ToadProduct(gm, "clother/boots.png", 970, 500, 50);
